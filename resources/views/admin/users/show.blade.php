...
<div class="content-wrapper">
 <section class="content-header">
  <h1 class="text-primary">
    <strong><i class="fa fa-user "></i> User Detail </strong>
  </h1>
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="name" value="@if($user->state==0) {{'Active'}} @else {{'Not Active'}} @endif">
  ...
  <input type="text" class="form-control" id="name" value="{{$count}}">
    ...
    <div class="row">
     <div class="col-md-6">
      ...
      <div class="form-group">
       <a href="{{ route('allDevice',$user->id) }}" class="btn btn-primary ">
        <i class="fa fa-mobile"></i> See User Devices</a>
      </div>
