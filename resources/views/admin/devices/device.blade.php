  ...
  <section class="content">
    ...
    <div class="box box-primary">
      <div class="box-header with-border bg-success">
        <center><h3 class="box-title"><i class="fa fa-plus"></i><strong> Add New Device</strong></h3></center>
      </div>
      <!-- /.box-header -->
      <!-- form start -->
         ...
         <div class="row">
           ...
           <div class="col-md-6 col-md-offset-3">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="name" placeholder="Enter Device Name" name="Type"
              required="true" autofocus="true" value="{{old('Type')}}" pattern="[a-zA-Z'\s]+" title="Only Alphabates Are Allowed">
            </div>
