@extends('admin.layouts.app1')
 ...
 <div class="content-wrapper">
     <section class="content-header" >
      <h1>
        <i class="fa fa-user"></i> Users Form
        
      </h1>
      <ol class="breadcrumb" style="background-color: #E6E6FA;margin-right: 10px;">
    ...
    <section class="content">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ route('rel.store') }}" method="post" >
            	{{csrf_field()}}
              <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="numbers" placeholder="Enter Retailer Cnic" name="retailer_id" value="{{ old('retailer_id') }}" required="" pattern="^[1-4]{1}[0-9]{4}(-)?[0-9]{7}(-)?[0-9]{1}$" title="3420281569919 | 34202-8156991-9">
                </div>
